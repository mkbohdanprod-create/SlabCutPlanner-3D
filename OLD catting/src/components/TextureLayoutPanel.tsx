...
import { Detail, DetailPart, Rotation, SlabInstance, TextureFrame, TextureLayout } from '../domain/types';
...
function textureCoordinateMatrix(part: DetailPart, sourceRotation: Rotation, layoutRotation: Rotation, scale: number) {
    ...
    <section className="panel texture-panel">
      ...
      {floatingPreviewOpen && (
        ...
        >
          ...
          <div className="texture-preview-body" onWheel={onWheel}>
            <TextureScene
              items={items}
              frames={textureFrames}
              activeFrameId={activeFrameId}
