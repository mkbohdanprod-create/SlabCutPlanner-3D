 ...
 *
 * Відкривається ПОДВІЙНИМ кліком по «stone» у шапці (№165: вікно з
 * паролем прибране — код лежав у вихідниках відкритим рядком, а репозиторій
 * публічний). Застосунок під студією лишається змонтованим: вона — шар
 * поверх, вихід повертає рівно туди, де людина була.
 */
